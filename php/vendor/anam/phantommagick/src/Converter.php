...
class Converter extends Runner
{
    ...
    public function saveLocal($filename)
    {
     ...
     // die('esimage ' . self::$scripts['converter']);
        // Image
        // self::$scripts['converter'] = "C:\wamp64\www\Desarrollo\canvasnode\phantomjs-2.1.1-windows\phantomjs-2.1.1-windows\bin\phantomjs";
